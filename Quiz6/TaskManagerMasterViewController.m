//
//  TaskManagerMasterViewController.m
//  Quiz6
//
...
#import "TaskManagerDetailViewController.h"
#import "Task.h"

@interface TaskManagerMasterViewController () {
    NSMutableArray *_objects;
}
@end

@implementation TaskManagerMasterViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (!self.detailViewController) {
        self.detailViewController = [[TaskManagerDetailViewController alloc] initWithNibName:nil bundle:nil];
    }
    NSDate *object = [_objects objectAtIndex:indexPath.row];
